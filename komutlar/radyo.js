...
const radio = {
    "fenomenturk": "https://www.radyofenomen.com/fenomenturk/",
    ...
    "efkarlı": "http://www.radyodinle.fm/#best-fm-98-4"
      ...
      if (!args) return msg.channel.send('❌ | Bir Radyo Seçin : **franceinfo**, **efkarlı**, **rtl2**, **skyrock**, **rtl**, **rfm**, **bfm**')

        if(!radio[args]) return msg.channel.send('❌ | Lütfen Yandaki Radiolardan Birini Seç : **franceinfo**, **efkarlı**, **rtl2**, **skyrock**, **rtl**, **rfm**, **bfm**')
