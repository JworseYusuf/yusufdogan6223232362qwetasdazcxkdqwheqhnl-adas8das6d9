...
console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}] BOT: Şu an ` + client.channels.size + ` adet kanala, ` + client.guilds.size + ` adet sunucuya ve ` + client.users.size + ` kullanıcıya hizmet veriliyor!`);

    var Games = [
                "»» HayDo BOT «« ",
                "»» *V.04 ««",
                "»» Daha Herşey Yeni Başladı «« ",
                "»» HayDo BOT «« ",
